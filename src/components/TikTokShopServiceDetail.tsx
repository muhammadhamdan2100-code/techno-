...
const faqs = [
  {
    ...
    answer:
      "We handle TikTok Seller Center verification, catalog integration with Shopify/WooCommerce, shipping policy setup, payment gateway binding, and creator affiliate portal configuration.",
  },
  {
    question: "How do you drive sales through creator affiliates on TikTok?",
    answer:
      "We build and recruit UK creator affiliate networks, manage sample dispatching, set commission structures, and coordinate viral UGC video product reviews.",
  },
  {
    question: "Can you produce viral short-form videos for our TikTok Shop products?",
    answer:
      "Yes. We script, produce, and edit high-performing TikTok video hooks, product showcases, and shoppable video ads designed to drive instant in-app purchases.",
  },
  {
    question: "What results can we expect from TikTok Shop marketing?",
    answer:
      "TikTok Shop provides direct frictionless purchasing. With proper creator outreach and paid Spark Ads, products often achieve rapid momentum within 2 to 4 weeks.",
  },
  {
    question: "Do we need existing TikTok followers to start selling?",
    answer:
      "No. TikTok Shop products are discovered primarily through the algorithm FYP (For You Page) and affiliate creator posts, meaning brand new shops can generate sales immediately.",
  },
];

const tikTokModules = [
  {
    title: "TikTok Store Setup & Verification",
    description:
      "End-to-end UK TikTok Seller Center onboarding, business document verification, and warehouse policy configuration.",
    icon: <Store className="w-6 h-6 text-[#2563EB]" />,
  },
  {
    title: "Catalog & E-Commerce Integration",
    description:
      "Seamlessly synchronizing your existing Shopify, WooCommerce, or inventory systems with the TikTok product catalog.",
    icon: <ShoppingBag className="w-6 h-6 text-[#2563EB]" />,
  },
  {
    title: "Creator & Affiliate Outreach",
    description:
      "Recruiting targeted UK content creators, negotiating sample dispatching, and managing affiliate commission payouts.",
    icon: <Users className="w-6 h-6 text-[#2563EB]" />,
  },
  {
    title: "Viral UGC Video Production",
    description:
      "Scripting, filming, and editing high-converting short-form product videos engineered for TikTok algorithm FYP virality.",
    icon: <Video className="w-6 h-6 text-[#2563EB]" />,
  },
  {
    title: "Live Commerce & Broadcast Management",
    description:
      "Planning and executing live shopping streams on TikTok to drive real-time interactive product sales.",
    icon: <Globe className="w-6 h-6 text-[#2563EB]" />,
  },
  {
    title: "TikTok Paid Spark Ads",
    description:
      "Scaling top-performing organic creator videos into paid Spark Ads to amplify reach and accelerate store revenue.",
    icon: <TrendingUp className="w-6 h-6 text-[#2563EB]" />,
  },
  {
    title: "Shop Analytics & Revenue Scaling",
    description:
      "Real-time tracking of in-app conversion rates, affiliate sales leaderboards, average order values (AOV), and inventory health.",
...
const processSteps = [
  {
    step: "01",
    title: "Seller Center Setup",
    description: "Account creation, UK business verification, tax setup, and payment gateway binding.",
  },
  {
    step: "02",
    title: "Product Catalog Sync",
    description: "Uploading product listings, optimizing titles and tags, and syncing stock levels.",
  },
  {
    step: "03",
    title: "Creator Affiliate Sourcing",
    description: "Inviting relevant UK creators to your affiliate program and dispatching product samples.",
  },
  {
    step: "04",
    title: "Content & Live Launch",
    description: "Publishing shoppable UGC videos and launching live commerce shopping broadcasts.",
  },
  {
    step: "05",
    title: "Ad Scaling & Optimization",
    description: "Amplifying viral videos with Spark Ads and optimizing product conversions for maximum revenue.",
  },
];

export default function TikTokShopServiceDetail() {
            ...
            <div className="lg:col-span-5 w-full flex justify-center lg:justify-end">
              ...
              >
                <Image
                  ...
                  alt="TikTok Shop Agency Services UK"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0B132B]">
              Turn TikTok Virality Into Instant In-App Sales
            </h2>

            <p className="text-[#64748B] text-base sm:text-lg leading-relaxed">
              TikTok Shop is revolutionizing UK e-commerce by allowing users to purchase products directly within the TikTok feed without leaving the app. This friction-free shopping experience drives impulse buying at unmatched conversion rates.
            </p>

            <p className="text-[#64748B] text-base sm:text-lg leading-relaxed">
              At Techno Trade Solutions, we manage your entire TikTok Shop ecosystem—from initial Seller Center verification and catalog synchronization to creator affiliate outreach, shoppable video production, and paid Spark Ad scaling.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-white border border-blue-200 text-[#2563EB] text-xs font-semibold uppercase tracking-wider mb-3 shadow-xs">
              ...
              <span>TikTok Commerce Modules</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0B132B]">
              Our TikTok Shop Services
            </h2>
          </motion.div>
          ...
          <div className="p-8 sm:p-12 rounded-3xl bg-[#0B132B] text-white flex flex-col lg:flex-row items-center justify-between gap-8 shadow-xl">
            <div className="space-y-3 max-w-2xl">
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-white">
                Ready to Sell Your Products on TikTok?
              </h2>
              <p className="text-[#CBD5E1] text-sm sm:text-base leading-relaxed">
                Schedule a consultation with our TikTok commerce specialists to launch and scale your shop.
              </p>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-white border-b border-[#E5E7EB]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0B132B]">
              Why Choose Techno Trade for TikTok Shop?
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-white border border-[#E5E7EB] shadow-sm space-y-4">
              ...
              <h3 className="text-xl font-bold text-[#0B132B]">UK Creator Network</h3>
              <p className="text-[#64748B] text-sm leading-relaxed">
                Direct relationships with verified UK content creators who produce high-converting shoppable video reviews.
              </p>
            </div>

            <div className="p-8 rounded-3xl bg-white border border-[#E5E7EB] shadow-sm space-y-4">
              <div className="text-2xl font-black text-[#2563EB]">02</div>
              <h3 className="text-xl font-bold text-[#0B132B]">Full Shop Management</h3>
              <p className="text-[#64748B] text-sm leading-relaxed">
                We handle technical setup, catalog syncing, creator outreach, sample logistics, and ad campaigns.
              </p>
            </div>

            <div className="p-8 rounded-3xl bg-white border border-[#E5E7EB] shadow-sm space-y-4">
              <div className="text-2xl font-black text-[#2563EB]">03</div>
              <h3 className="text-xl font-bold text-[#0B132B]">Proven Sales Growth</h3>
              <p className="text-[#64748B] text-sm leading-relaxed">
                Data-driven Spark Ads and live commerce strategies that transform viral views into immediate revenue.
              </p>
            </div>
          </div>
        </div>
